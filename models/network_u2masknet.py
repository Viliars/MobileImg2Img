...
class U2Net(nn.Module):
    ...
    def forward(self,x):
        ...
        #stage 1
        mask1 = self.sigmoid1(self.stage1(hx_in))
        hx1 = self.pool12(hx_in)

        #stage 2
        mask2 = self.sigmoid2(self.stage2(hx1))
        hx2 = self.pool23(hx1)

        #stage 3
        mask3 = self.sigmoid3(self.stage3(hx2))
        hx3 = self.pool34(hx2)

        #stage 4
        mask4 = self.sigmoid4(self.stage4(hx3))
        hx4 = self.pool45(hx3)

        #stage 5
        mask5 = self.sigmoid5(self.stage5(hx4))
        hx5 = self.pool56(hx4)
